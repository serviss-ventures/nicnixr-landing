    ...
    <View style={styles.container}>
      <View style={styles.progressContainer}>
        <View style={styles.progressBar}>
          <LinearGradient colors={[COLORS.primary, COLORS.secondary]} style={[styles.progressFill, { width: '62.5%' }]} />
        </View>
        <Text style={styles.progressText}>Step 5 of 8</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.title}>Past Attempts</Text>
        <Text style={styles.subtitle}>Learning from your journey (coming soon)</Text>
      </View>
